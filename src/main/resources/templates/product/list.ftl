                    ...
                    <table class="table table-bordered table-condensed">
                        ...
                        <#list productInfoPage.content as productInfo>
                            <tr>
                                ...
                                <td><a href="/sell/seller/product/index?productId=${productInfo.productId}&page=${currentPage}">修改</a></td>
                                <td>
                                    <#if productInfo.productStatus==0>
                                        <a href="/sell/seller/product/off_sale?productId=${productInfo.productId}&page=${currentPage}">
                                            下架
                                        </a>
                                    <#else>
                                        <a href="/sell/seller/product/on_sale?productId=${productInfo.productId}&page=${currentPage}">
                                            上架
                                        </a>
                                    </#if>
                                </td>
